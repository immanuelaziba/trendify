# ** Contributors — Trendify**

This document lists all team members who contributed to the design, content, structure, and final engineering of the **Trendify** 5-page fashion brand website.
...
* Built the Inquiries & Booking page
...
* Collaborated on user-friendly product presentation
* **Supported by:** Ibebuike Chimereze Jethro
...
* Researched event-format inspirations
* **Supported by:** Ibebuike Chimereze Jethro
...
* Combined all CSS into a unified `styles.css`
* Cleaned file names and folder structure
* Repaired broken links, scripts, and assets
* Merged product pages into a single `products.html`
* Standardized navigation, footers, spacing, and responsiveness
* Organized JavaScript into modular files
* Ensured the entire project meets scoring/assessment requirements

---

## ** Additional Collaboration**

* Peer review across pages
* Style unification
* Cross-testing pages for consistency

---

## ** Appreciation**

Thanks to every team member for the shared effort, communication, and willingness to improve the project into a clean, cohesive, submit-ready website.
